...
<div className="container-fluid pt-3">
   <div className="row">
      ...
      <div className="col-md-6 rounded img-fluid"  style={{background: '#001F3F', color: 'white'}} data-aos="fade-up">
        ...
        <h2 >We Provide Full Range Technologies Solution</h2>
        <p className="intro" >We are dedicated to revolutionizing tech training and education in Africa. Our mission is to empower individuals, businesses, and communities with cutting-edge skills and knowledge, bridging the digital divide and unlocking the continent's full potential.</p >
...
<div className="col-md-6" data-aos="fade-up">
<h4>Send us message (For full enrolment <a href='/Curriculum' className="" type="submit">Register here</a>)</h4>
<FORM/>
</div>
