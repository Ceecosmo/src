...
// an Array of objects
const CardData = [
    { image: pic11, title: 'King David Oyekanmi', content_text: 'Chairman, Board of Director/CEO, Dayode Innovations: Oversees overall strategy, vision, and execution. Acts as the main point of communication between the team and external partners'},
    { image: pic12, title: 'Tomi Oyekanmi', content_text: 'COO/CFO (Chief Operating and Financial Officer), Dayode Innovations: Manages daily operations and financial planning. Ensures efficiency in administrative tasks and handles budgeting and financial reporting. Administrative and Support Team' },
    { image: pic10, title: 'Femi Oyekanmi Esq', content_text: 'Head of Legal Prime Africa Technologies, Dadoye Innovations' },

    
    { image: pic9, title: 'Adeolu Oyekanmi', content_text: 'CEO Prime Africa Technologies, CFO Dadoye Innovations'},
